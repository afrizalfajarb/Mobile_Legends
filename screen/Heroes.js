  ...
  render(){
    return(
      <View style={nbStyles.subtitle}>
          <Text style={{fontSize: 25, marginTop:20, textAlign: 'center', color: '#ffd615', fontWeight : 'bold'}}>
            PAHLAWAN
          </Text>
          ...
          <Image
           style={{alignItems: 'center', width: 370, height:160, marginBottom: 100, marginTop:1, }}
